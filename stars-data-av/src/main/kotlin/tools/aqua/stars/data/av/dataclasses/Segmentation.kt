...
class Segmentation() {
    ...
    companion object {
        fun STATIC_SEGMENT_LENGTH_TICKS(windowSize: Int, overlap: Int): Segmentation = Segmentation(type = Type.STATIC_SEGMENT_LENGTH_TICKS, value = windowSize, secondaryValue = max(((1-(overlap/100))*windowSize),1))
        fun STATIC_SEGMENT_LENGTH_METERS(windowSize: Int, overlap: Int): Segmentation = Segmentation(type = Type.STATIC_SEGMENT_LENGTH_METERS, value = windowSize, secondaryValue = max(((1-(overlap/100))*windowSize),1))
        fun DYNAMIC_SEGMENT_LENGTH_METERS_SPEED(stepSize: Int): Segmentation = Segmentation(type = Type.DYNAMIC_SEGMENT_LENGTH_METERS_SPEED, value = stepSize)
        fun DYNAMIC_SEGMENT_LENGTH_METERS_ACCELERATION(stepSize: Int): Segmentation = Segmentation(type = Type.DYNAMIC_SEGMENT_LENGTH_METERS_ACCELERATION, value = stepSize)
        fun DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_1(stepSize: Int): Segmentation = Segmentation(type = Type.DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_1, value = stepSize)
        fun DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_2(stepSize: Int): Segmentation = Segmentation(type = Type.DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_2, value = stepSize)
        fun SLIDING_WINDOW_MULTISTART_METERS(overlap: Int): Segmentation = Segmentation(type = Type.SLIDING_WINDOW_MULTISTART_METERS, value = overlap)
        fun SLIDING_WINDOW_MULTISTART_TICKS(overlap: Int): Segmentation = Segmentation(type = Type.SLIDING_WINDOW_MULTISTART_TICKS, value = overlap)
        //==============================================================================================================
        ...
        fun fromConsole(segmentationType: String, segmentationValue: Int?, secondarySegmentationValue: Int?, overlapPercentage: Double?, addJunctions: Boolean): Segmentation {
            return when (segmentationType) {
                "STATIC_SEGMENT_LENGTH_TICKS" -> STATIC_SEGMENT_LENGTH_TICKS(segmentationValue?: 120, secondarySegmentationValue?: 25)
                "STATIC_SEGMENT_LENGTH_METERS" -> STATIC_SEGMENT_LENGTH_METERS(segmentationValue?: 70, secondarySegmentationValue?: 25)
                "DYNAMIC_SEGMENT_LENGTH_METERS_SPEED" -> DYNAMIC_SEGMENT_LENGTH_METERS_SPEED(segmentationValue?: 5)
                "DYNAMIC_SEGMENT_LENGTH_METERS_ACCELERATION" -> DYNAMIC_SEGMENT_LENGTH_METERS_ACCELERATION(segmentationValue?: 5)
                "DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_1" -> DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_1(segmentationValue?: 5)
                "DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_2" -> DYNAMIC_SEGMENT_LENGTH_METERS_SPEED_ACCELERATION_2(segmentationValue?: 5)
                "SLIDING_WINDOW_MULTISTART_METERS" -> SLIDING_WINDOW_MULTISTART_METERS(segmentationValue?: 25)
                "SLIDING_WINDOW_MULTISTART_TICKS" -> SLIDING_WINDOW_MULTISTART_TICKS(segmentationValue?: 25)
                //======================================================================================================
                "NONE" -> NONE
                "BY_BLOCK" -> BY_BLOCK
